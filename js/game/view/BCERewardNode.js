...
define( function( require ) {
  ...
  var NODES = [
    ...
    // level 2: molecules
    [
      new CNode( ATOM_OPTIONS ),
      new C2H2Node( ATOM_OPTIONS ),
      new C2H4Node( ATOM_OPTIONS ),
      new C2H5ClNode( ATOM_OPTIONS ),
      new C2H5OHNode( ATOM_OPTIONS ),
      new C2H6Node( ATOM_OPTIONS ),
      new CH2ONode( ATOM_OPTIONS ),
      new CH3OHNode( ATOM_OPTIONS ),
      new CH4Node( ATOM_OPTIONS ),
      new Cl2Node( ATOM_OPTIONS ),
      new CONode( ATOM_OPTIONS ),
      new CO2Node( ATOM_OPTIONS ),
      new CS2Node( ATOM_OPTIONS ),
      new F2Node( ATOM_OPTIONS ),
      new CONode( ATOM_OPTIONS ),
      new H2Node( ATOM_OPTIONS ),
      new H2ONode( ATOM_OPTIONS ),
      new H2SNode( ATOM_OPTIONS ),
      new HClNode( ATOM_OPTIONS ),
      new HFNode( ATOM_OPTIONS ),
      new N2Node( ATOM_OPTIONS ),
      new N2ONode( ATOM_OPTIONS ),
      new NH3Node( ATOM_OPTIONS ),
      new NONode( ATOM_OPTIONS ),
      new NO2Node( ATOM_OPTIONS ),
      new O2Node( ATOM_OPTIONS ),
      new OF2Node( ATOM_OPTIONS ),
      new P4Node( ATOM_OPTIONS ),
      new PCl3Node( ATOM_OPTIONS ),
      new PCl5Node( ATOM_OPTIONS ),
      new PH3Node( ATOM_OPTIONS ),
      new PF3Node( ATOM_OPTIONS ),
      new SNode( ATOM_OPTIONS ),
      new SO2Node( ATOM_OPTIONS ),
      new SO3Node( ATOM_OPTIONS )
    ],
