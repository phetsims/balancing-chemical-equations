...
define( function() {
   ...
   * @param equation
   */
  HorizontalAligner.prototype.getReactantXOffsets = function( equation ) {
   ...
   * @param equation
   */
  HorizontalAligner.prototype.getProductXOffsets = function( equation ) {
   ...
   * @param xAdjustment
   */
  HorizontalAligner.prototype.getXOffsets = function( terms, leftJustified, xAdjustment ) {
