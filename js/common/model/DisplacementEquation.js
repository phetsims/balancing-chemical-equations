...
define( require => {
  ...
  class DisplacementEquation extends Equation {
     ...
     */
    constructor( r1, reactant1, r2, reactant2, p1, product1, p2, product2, options ) {
      super(
  ...
  return balancingChemicalEquations.register( 'DisplacementEquation', DisplacementEquation );
} );